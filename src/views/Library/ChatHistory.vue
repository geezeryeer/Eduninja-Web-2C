    ...
    >
      ...
      <div class="p-4 border-t border-gray-200">
        <button
          ...
          class="w-full px-4 py-2 text-sm font-medium text-red-600 hover:bg-red-50 rounded-lg transition-colors"
        >
          Clear All History
        </button>
      </div>
...
// Emits
const emit = defineEmits(['close', 'select-chat', 'delete-chat', 'clear-all'])
