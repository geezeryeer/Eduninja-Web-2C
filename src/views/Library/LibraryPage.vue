<template>
  <div class="h-full flex flex-col min-w-0 overflow-hidden">
    <!-- 过滤器组件 -->
    <div class="px-6 pt-6 pb-2 relative z-50">
      <LibraryFilter
    ...
    <div 
      ref="scrollContainer" 
      class="flex-1 overflow-y-auto custom-scrollbar px-6 py-6 relative z-0"
    >
      <!-- 加载状态 -->
...
import LibraryFilter from './Page/LibraryFilter.vue'
...
const mappers = {
  paper: (item) => ({
    ...
    fileAnswerUrl: item.fileAnswerUrl || item.answerUrl,
