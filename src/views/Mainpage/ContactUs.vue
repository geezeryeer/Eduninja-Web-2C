      ...
      <div class="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 pt-24 pb-8">
        ...
        <div class="flex justify-between items-center mb-4">
          <p class="text-gray-600 text-lg">
            Email us directly at <a href="mailto:service@eduninja.net" class="text-link font-medium hover:text-link-dark hover:underline">service@eduninja.net</a> or use the form below.
          </p>
