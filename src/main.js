...
const routes = [
    ...
    children: [
      {
        path: '',
        name: 'Library',
        component: () => import('./views/Library/Page/LibraryPage.vue'),
        meta: {
          title: 'Library',
          requiresAuth: true
        }
      ...
      },
      {
        path: 'chat',
        name: 'Chat',
        component: () => import('./views/Library/AIPanel/AIChatPanel.vue'),
        meta: {
          title: 'AI Assistant',
          requiresAuth: true
        }
      },
      {
        path: 'flashcards',
        name: 'Flashcards',
        component: () => import('./views/Library/Page/Flashcards.vue'),
        meta: {
          title: 'Flashcards',
          requiresAuth: true
        }
      },
      {
        path: 'syllabus',
        name: 'Syllabus',
        component: () => import('./views/Library/Page/Syllabus.vue'),
        meta: {
          title: 'Syllabus',
          requiresAuth: true
        }
  ...
  // 问卷页面
  {
    path: '/questionnaire',
    name: 'Questionnaire',
    component: () => import('./views/Login/Questionnaire.vue'),
    meta: {
      title: 'Welcome to EduNinja',
